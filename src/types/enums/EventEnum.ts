...
// 全局组件教会回调事件触发的类型(也可以自定义名称)
export enum InteractEventsOn {
  CLICK = 'click',
  CHANGE = 'change',
}
...
export enum EventLife {
  ...
  // 渲染之前
  VNODE_BEFORE_MOUNTED = 'vnodeBeforeMounted',
}

// 内置字符串函数对象列表
export const excludeParseEventKeyList = [
  EventLife.VNODE_BEFORE_MOUNTED,
  EventLife.VNODE_MOUNTED,
  BaseEvent.ON_CLICK,
  BaseEvent.ON_DOUBLE_CLICK,
